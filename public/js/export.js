...
function exportFile(ics) {
    ...
    if (!empty(dateDebut) && !empty(dateFin) && !empty(categorie) && !empty(choices)) {
        ...
        $("#messageForUser").append(
            ` <div class ="alert alert-warning">Missing parameter, please indicate a start time</div>`
        );
    } else if (empty(dateFin)) {
        $("#messageForUser").append(
            ` <div class ="alert alert-warning">Missing parameter, please indicate an end time</div>`
        );
    } else if (empty(categorie)) {
        $("#messageForUser").append(
            ` <div class ="alert alert-warning">Missing parameter, please make a choice between the different categories</div>`
        );
    } else if (empty(choices)) {
        $("#messageForUser").append(
            ` <div class ="alert alert-warning">Missing parameter, please make a choice between the different ` + categorie + `</div>`
        );
    }
}
